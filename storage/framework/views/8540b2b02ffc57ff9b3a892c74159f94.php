...
<body class="bg-gray-100">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6 bg-white p-8 rounded-lg shadow" method="POST" action="<?php echo e(route('login')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\BARIŞ\Desktop\OOP\it_support_ticket_system\resources\views/auth/login.blade.php ENDPATH**/ ?>